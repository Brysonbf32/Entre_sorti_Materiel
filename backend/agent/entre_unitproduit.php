...
if(isset($_GET['id_prod'])){
    ...
    if(isset($ref_prod)){
        ...
        if($checkdata >0){
            ...
            if(isset($id_pro)){
                $recudatapro=$my_bd->prepare("SELECT * FROM tbl_produits WHERE id_pro=?");
                ...
                if($checkdatapro >0){
                    ...
                    if(isset($id_fourni)){
                        $recudatafourni=$my_bd->prepare("SELECT * FROM tbl_fournisseurs WHERE id_fourni=?");
         ...
         try{
            ...
            if(isset($identre)){
                ...
                if($checks >0){
                    ...
                    $inserthisto=$my_bd->prepare("INSERT INTO tbl_historic_pro(id_pro,id_fourni,id_util,date_entre,quanti_entre)VALUES(?,?,?,?,?)");
                    $inserthisto->execute(array($id_pro,$id_fourni,$idutil,$date_entre,$quant_entree));
