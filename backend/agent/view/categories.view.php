                                                ...
                                                <div class="widget-shadow ">
                                                    ...
                                                    <div class="modal-body">
                                                        <div class="row">
                                                            ...
                                                            <label class="label_text">Etagiaire</label>
                                                            <select name="id_etag" class="form-control">
                                                            <option>Choisie Etagiaire</option>
                                                            <?php
    ...
    <div class="modal-dialog" role="document">
        ...
        <div class="modal-body">
            <div class="row">
                ...
                <div class="col-12 col-lg-6 py-2">
                    <label class="label_text">Code Categorie</label>
                    <input type="text" name="code_categ"  class="form-control" required>
                </div>
                <div class="col-12 col-lg-6 py-2">
                    <label class="label_text">Nom Categorie</label>
