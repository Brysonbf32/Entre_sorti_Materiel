							 ...
							 <div class="agileinfo-cdr">             
                                <div class="card-header">
                                    <div class="row">
                                        ...
                                        <input type="search" id="searchda"   placeholder="Search" class="form-control"><button class="search_icon" type="submit"></button>
                                        </div>
                                    </div>
                                </div>
                                 <div class="widget-body">
                                    <table class="table">
                                         <thead>
                                            ...
                                            nom_fourni
                                            FROM
                                            tbl_entre_produits AS entpro INNER JOIN tbl_produits AS prod ON(entpro.id_pro=prod.id_pro) INNER JOIN tbl_fournisseurs AS four ON(entpro.id_fourni=four.id_fourni) INNER JOIN tbl_utilisateurs AS uti ON(entpro.id_util=uti.id_util)";
